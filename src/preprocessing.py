...
Vai trò của preprocessing.py là:
    ...
    4. Loại tạm các subject vi phạm protocol thu thập dữ liệu.
...
# ============================================================
# 8. LOẠI SUBJECT SAI ACQUISITION PROTOCOL
# ============================================================
...
def filter_protocol_invalid(
    ...
    """
    Loại tạm các person đã biết chắc chắn sai protocol thu thập.

    Đây KHÔNG phải outlier filtering.

    Hiện tại:
        person05 được quay từ phía camera không đúng protocol.

    Vì vậy:
        - vẫn giữ trong EDA để trace;
        - có thể loại tạm khi modeling.

    Sau khi person05 được quay lại đúng protocol:
        excluded_persons = ()
    """
...
def prepare_dataset(
    ...
    # BƯỚC 6: Loại tạm các subject sai protocol nếu có.
...
def print_preprocessing_summary(
    ...
    print("=" * 60)
    print(
        "PASS: Dataset đã sẵn sàng bàn giao cho train.py"
    )
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    # --------------------------------------------------------
    #
    # person05 hiện có recording sai camera protocol.
    #
    # Vì vậy:
    #     giữ trong EDA
    #     nhưng tạm loại khi modeling.
    #
    # Sau khi quay lại person05 đúng protocol và rebuild CSV:
    #
    #     excluded_persons = ()
    #
    excluded_persons = (
